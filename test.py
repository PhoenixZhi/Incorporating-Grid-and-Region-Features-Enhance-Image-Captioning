...
import evaluation
from models.transformer import Transformer, Encoder, Decoder, ScaledDotProductAttention
import torch
...
if __name__ == '__main__':
    ...
    image_field = ImageDetectionsField(detections_path=args.features_path, max_detections=150, load_in_tmp=False)
    ...
    data = torch.load('/home/phoenix/Desktop/A/saved_models/ORT_last.pth')
